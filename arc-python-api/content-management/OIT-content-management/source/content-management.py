...
for i in user_list:
    ################################# Enter the AGOL usernames of the people you want to include. Add more if necessary. If you are sending to everyone in your organization, there is a way to programmatically get it using gis.users.search(query = '*', max_users = 10000)############################################
    if i.username == "USERNAME" or i.username == "USERNAME" or i.username == "USERNAME" or i.username == "USERNAME" or i.username == "USERNAME":
